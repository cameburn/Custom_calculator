...
function ShowSelectionMenu(button) {
    ...
    selectionMenu.style.left = `${rect.left + 10 - 45 + window.pageXOffset}` + "px";
    selectionMenu.style.top = `${rect.top + 10 - 31.5 + window.pageYOffset}` + "px";
...
function ShowSelectionOpetatorMenu(button) {
    ...
    var rect = button.getBoundingClientRect();
    selectionOperatorMenu.style.left = `${rect.left + 10 - 45 + window.pageXOffset}` + "px";
    selectionOperatorMenu.style.top = `${rect.top + 10 - 31.5 + window.pageYOffset}` + "px";
    currentButton = button;
}
...
function createInt() {
    ...
    if(currentButton.name == "upper_create_button") {
        ...
        calcContainerRect = calcContainer.getBoundingClientRect();
        if(itemsWidth > calcContainerRect.width - 100) {
            calcContainer.style.width = calcContainerRect.width + itemsWidth - (calcContainerRect.width - 100) + "px";
        }
    }
